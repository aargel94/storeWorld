...
export const Descriptions = ()=>{
    ...
    const buttonStyles= cx('Description_button', {
        'Description_button--border':hasBorder,
    })
    ...
    return(
        <section className={styles.Description}>
            ...
            <div className={styles.Description_text}>
                <h2>Description</h2>
                <p>loremLorem ipsum dolor sit am Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
                    nonumy eirmod tempor in </p>
            </div>
